...
import { Camera, Edit2, Mail, Phone, MapPin, Calendar, User, Globe, Trash2, Heart, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'destinations' && (
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-gray-400 text-sm">{savedDestinations.length} destinations</span>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {savedDestinations.map((destination) => (
                <div key={destination.id} className="group relative bg-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-blue-500 transition-all duration-300">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center space-x-1 mt-1 text-gray-400">
                      ...
                      <span className="text-sm">Saved {destination.savedDate}</span>
                    </div>
        ...
        {activeTab === 'settings' && (
          <div className="max-w-3xl">
            <h2 className="text-2xl font-bold text-white mb-6">Settings & Privacy</h2>
            ...
            <div className="bg-gray-800 rounded-xl border border-gray-700 p-6 mb-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-white font-semibold text-lg mb-2">Language Preference</h3>
                  <p className="text-gray-400 text-sm mb-4">Choose your preferred language for the application</p>
                  <select
                    name="language"
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Allow others to see your profile and trips</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Receive updates about your trips</p>
                  </div>
                  <input
                    type="checkbox"
                    className="w-5 h-5 rounded bg-gray-700 border-gray-600 text-blue-600 focus:ring-blue-500"
                ...
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Help improve recommendations</p>
                  </div>
                  <input
                    type="checkbox"
                    className="w-5 h-5 rounded bg-gray-700 border-gray-600 text-blue-600 focus:ring-blue-500"
