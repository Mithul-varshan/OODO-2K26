...
const Profile = () => {
  ...
  useEffect(() => {
    // Component mounts with language from context
  }, [language]);
  ...
  const handleLanguageChange = (e) => {
    ...
    showNotification(
      `${t('languageChanged')} ${selectedLang?.name}. ${t('languageApplied')}`
    );
  };
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-blue-400 text-xs mb-4">
                    Current:{" "}
                    {
                      languages.find((l) => l.code === userDetails.language)
                        ?.name
                    }
                  </p>
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full md:w-64 bg-gray-700 text-white px-4 py-2 rounded-lg border border-gray-600 focus:border-blue-500 focus:outline-none transition-colors hover:border-blue-400"
                  >
                    {languages.map((lang) => (
