...
const translations = {
  ...
  es: {
    ...
    adventure: "Aventura",
    discoverDestinations:
      "Descubre destinos increíbles, crea itinerarios personalizados y haz realidad tus sueños de viaje.",
  ...
  fr: {
    ...
    adventure: "Aventure",
    discoverDestinations:
      "Découvrez des destinations incroyables, créez des itinéraires personnalisés et réalisez vos rêves de voyage.",
  ...
  de: {
    ...
    adventure: "Abenteuer",
    discoverDestinations:
      "Entdecken Sie erstaunliche Reiseziele, erstellen Sie personalisierte Reiserouten und verwirklichen Sie Ihre Reiseträume.",
